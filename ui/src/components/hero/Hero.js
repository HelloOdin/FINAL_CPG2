...
import turon from '../../static/turon.jpg';
import teriyaki from '../../static/beefteriyaki.jpg';
import curry from '../../static/chickencurry.jpg';
    ...
    return (
        <Container>
            ...
            >
                ...
                >
                    <StyledCard sx={{ backgroundImage: `url(${turon})` }}
                ...
                <Grid item md={3} xs={6}>
                    <StyledCard sx={{ backgroundImage: `url(${teriyaki})` }}>
                        <StyledWrapper>
                            <StyledTypography>
                                Beef Teriyaki
                            </StyledTypography>
                ...
                <Grid item md={3} xs={6}>
                    <StyledCard sx={{ backgroundImage: `url(${curry})` }}>
                        <StyledWrapper>
                            <StyledTypography>
                                Chicken Curry
                            </StyledTypography>
