...
const Navbar = () => {
        ...
        <StyledToolbar>
            <Box flex={{xs:25, md:1}}>
                <Link href="http://localhost:3000/" sx={{ textDecoration:"none"}}>
                    ...
                    color={'#568203'}
                    sx={{fontFamily:'Righteous, cursive', textAlign:{xs:'center', md:'left'}}}
            ...
            <Box flex={1}>
                ...
                <MenuRoundedIcon sx={{ display: { xs: "flex", md:"none", cursor:"pointer" }}}
    ...
    sx={{
        ...
        >
            Recipes that any college students can make!
        </Typography>
        <Typography align='center' variant="h5" color={'#568203'} sx={{fontFamily:'Righteous, cursive'}}
